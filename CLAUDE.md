...
- **Diagnostic placement** — IRT-style adaptive quiz, seeds the fingerprint (rawScore is pure accuracy: correctCount/attemptCount × 100, confidence 0.4). Cold-start traced and confirmed: new users get real adaptation from session one.
